    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- basic table -->
                 <a href="tambahpetugas.php" class="btn btn-sm btn-primary me-3">+ Tambah Petugas</a>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                     <?php
                                        ...
                                        $sql = "SELECT id_petugas, nama_petugas, jabatan, username, foto FROM petugas";
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                <?php
                                                                // Cek apakah ada foto, kalau kosong pakai default
                                                                $foto = !empty($row['foto']) ? 'uploads/petugas/' . $row['foto'] : 'assets/img/user.png';
                                                                ?>
                                                                <img src="<?php echo $foto; ?>" class="avatar avatar-sm me-3 border-radius-lg" alt="user" style="width:40px; height:40px; object-fit:cover;">
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm"><?php echo htmlspecialchars($row['nama_petugas']); ?></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0"><?php echo htmlspecialchars($row['jabatan']); ?></p>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs text-secondary mb-0"><?php echo htmlspecialchars($row['username']); ?></p>
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="editpetugas.php?id=<?= $row['id_petugas'] ?>" class="btn btn-warning btn-sm">Edit</a>

                                                        <a href="hapuspetugas.php?id=<?= $row['id_petugas'] ?>" 
