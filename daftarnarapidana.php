    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Daftar Narapidana</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- basic table -->
                 <a href="tambahnarapidana.php" class="btn btn-sm btn-primary me-3">+ Tambah Narapidana</a>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                     <?php
                                    include 'koneksi.php';
                                    $query = mysqli_query($koneksi, "SELECT * FROM napi");
                                    ?>
                                        ...
                                        <tbody>
                                         <?php while($row = mysqli_fetch_assoc($query)) { ?>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    <img src="uploads/napi/<?php echo $row['foto']; ?>" class="avatar avatar-sm me-3 border-radius-lg" alt="foto" style="width:40px; height:40px; object-fit:cover;">
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><?php echo $row['nama_lengkap']; ?></h6>
                                                    <p class="text-xs text-secondary mb-0"><?php echo $row['tempat_lahir'] . ', ' . $row['tanggal_lahir']; ?></p>
                                                </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $row['kasus']; ?></p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $row['tanggal_masuk']; ?></p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $row['tanggal_bebas']; ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php if($row['status_aktif'] == 'aktif') { ?>
                                                <span class="badge badge-sm bg-gradient-success">Aktif</span>
                                                <?php } else { ?>
                                                <span class="badge badge-sm bg-gradient-secondary">Bebas</span>
                                                <?php } ?>
                                            </td>
                                            <td class="align-middle">
                                                <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal<?php echo $row['id_napi']; ?>">Detail</button>
                                                <a href="editnarapidana.php?id=<?php echo $row['id_napi']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <a href="hapusnarapidana.php?id=<?php echo $row['id_napi']; ?>" 
                                            ...
                                            <!-- Modal Detail -->
                                            <div class="modal fade" id="detailModal<?php echo $row['id_napi']; ?>" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        <img src="uploads/napi/<?php echo $row['foto']; ?>" class="img-fluid rounded" alt="foto">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <p><strong>Nama Lengkap:</strong> <?php echo $row['nama_lengkap']; ?></p>
                                                        <p><strong>Tempat, Tanggal Lahir:</strong> <?php echo $row['tempat_lahir'] . ', ' . $row['tanggal_lahir']; ?></p>
                                                        <p><strong>Jenis Kelamin:</strong> <?php echo $row['jenis_kelamin']; ?></p>
                                                        <p><strong>Alamat:</strong> <?php echo $row['alamat']; ?></p>
                                                        <p><strong>Kasus:</strong> <?php echo $row['kasus']; ?></p>
                                                        <p><strong>Tanggal Masuk:</strong> <?php echo $row['tanggal_masuk']; ?></p>
                                                        <p><strong>Tanggal Bebas:</strong> <?php echo $row['tanggal_bebas']; ?></p>
                                                        <p><strong>Blok:</strong> <?php echo $row['blok']; ?></p>
                                                        <p><strong>Kamar:</strong> <?php echo $row['kamar']; ?></p>
                                                        <p><strong>Status:</strong> <?php echo ucfirst($row['status_aktif']); ?></p>
                                                    </div>
                                                    </div>
                                                </div>
