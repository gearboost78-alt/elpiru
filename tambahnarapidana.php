            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Tambah Data Narapidana</h4>
                    </div>
                    <div class="card-body">
                        <form action="prosestambahnapi.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="tanggal_bebas" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <a href="daftarnarapidana.php" class="btn btn-secondary">Batal</a>
                        </form>
                    </div>
                </div>
                <!-- ============================================================== -->
