            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Daftar Laporan</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                                        ...
                                        // Query ambil data absensi lengkap beserta nama napi dan nama petugas
                                        $sql = "
                                            SELECT a.id_absensi, n.nama_lengkap AS nama_napi, a.tanggal_waktu, 
                                                a.jenis_absensi, a.alasan, a.keterangan, a.waktu_masuk, p.nama_petugas
                                            FROM absensi_keluar_masuk a
                                            INNER JOIN napi n ON a.id_napi = n.id_napi
                                            INNER JOIN petugas p ON a.id_petugas = p.id_petugas
                                            ORDER BY a.tanggal_waktu DESC
                                        ";
                                        ...
                                        <tbody>
                                            <?php if (mysqli_num_rows($result) > 0): ?>
                                                <?php while($row = mysqli_fetch_assoc($result)): ?>
                                                    <tr>
                                                        <td><?php echo htmlspecialchars($row['nama_napi']); ?></td>
                                                        <td><?php echo date('d/m/Y H:i', strtotime($row['tanggal_waktu'])); ?></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                if (!empty($row['waktu_masuk'])) {
                                                                    echo date('d/m/Y H:i', strtotime($row['waktu_masuk']));
                                                                } else {
                                                                    echo '-';
                                                                }
                                                            ?>
                                                ...
                                                <?php endwhile; ?>
                                            <?php else: ?>
                                                <tr><td colspan="8" class="text-center">Data absensi tidak ditemukan.</td></tr>
                                            <?php endif; ?>
                                        </tbody>
                                        <tfoot>
                                            <tr>
